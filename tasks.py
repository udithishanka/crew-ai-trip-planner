...
class TravelTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        return Task(
            description=dedent(
                f"""
            **Task**: Develop a Detailed 7-Day Travel Itinerary
            **Description**: Expand the city guide into a full 7-day travel itinerary with detailed 
                ...
                and a budget breakdown. Budget should be in that particular country's currency, find the cheepest methods. You MUST suggest actual places to visit, actual hotels to stay, 
        ...
        """
            ...
            agent=agent,
            expected_output="A detailed itinerary PDF with daily schedules, attractions, accommodations, and dining options."
        )
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        ...
        """
            ...
            agent=agent,
            expected_output="A comprehensive report with the chosen city, reasoning for selection, and detailed travel logistics."
        )
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="A detailed city guidebook in PDF format with sections on attractions, dining, and local tips."
        )
